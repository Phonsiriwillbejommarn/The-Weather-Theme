...
| `prepare_thai_data.py` | เตรียม Dataset ภาษาไทย (MC4 + Oscar) พร้อม Heuristic Filter + Tokenize + Pack เป็น Block 4096 tokens |
...
# → สร้าง ./thai_cpt_data/shard_00000/, shard_00001/, ...
```
...
Sources: **MC4 (th)** + **Oscar OSCAR-2301 (th)**  
